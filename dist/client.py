...
from client_commands.stats import Stats
...
with open(r"assets\player_data.json") as data:
    ...
    class Client:
        ...
        @staticmethod
        async def Rarity(ctx): await Rarity(ctx)
        
        @staticmethod
        async def Amazon(ctx, arg): await Amazon(ctx, arg)
        ...
        async def Levels(self, ctx, arg): await Levels(ctx, arg, self)

        @staticmethod
        async def Bouliste(ctx): await Bouliste(ctx)
        
        async def Stats(self, ctx, arg): await Stats(ctx, arg, self)

        @staticmethod
        async def Daily(ctx): await Daily(ctx)
        ...
        @staticmethod
        async def bronJames(ctx, arg): await bronJames(ctx, arg)
