...
async def Shop(ctx, buy):
    ...
    if c:
        ...
        if not buy:
            ...
            rank_embed.add_field(name="`1` - GRADE | 🟩 - Novice :", value="Prix : `1,000€`", inline=False)
            rank_embed.add_field(name="`2` - GRADE | 🟦 - Initié :", value="Prix : `10,000€`", inline=False)
            rank_embed.add_field(name="`3` - GRADE | 🟨 -  Affirmé :", value="Prix : `100,000€`", inline=False)
            rank_embed.add_field(name="`4` - GRADE | 🟪 - Professionel :", value="Prix : `500,000€`", inline=False)
            rank_embed.add_field(name="`5` - GRADE | 🐱‍🏍 - Légende :", value="Prix : `1,000,000€`", inline=False)
            rank_embed.add_field(name="`8` - GRADE | 🧚‍♂️ - Divin:", value="Prix : `2,500,000€`", inline=False)
            rank_embed.add_field(name="`9` - GRADE | 👑 - N°1 :", value="Prix : `5,000,000€`", inline=False)
            ...
            if data[id]["Level"] >= 15:
                ...
                forge_embed.add_field(name=f"`2` - 🍀|Lucky-Hammer : `25 Lucky Stones`, `1,500 Points de Forgeron`, `150,000€`.", value=f"Vos chances d'obtenir des récompenses dans la `Fontaine Sacrée`, sont augmentées de `15%`.", inline=True)
